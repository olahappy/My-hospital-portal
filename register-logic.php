...
elseif(!$avatar['name']){
   ...
   if($password !== $cpassword){
    $_SESSION['signup'] = "Passwords do not match!";
     ...
     $user_check_query = "SELECT * FROM patients where username = '$username' OR email = '$email' ";
...
if($_SESSION['signup']){
   ...
   $inset_new_user = "INSERT INTO patients ( username , email, password, file , is_admin) VALUES('$username', '$email', '$password', '$avatar_name', 0)" ;
