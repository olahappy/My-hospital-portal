    ...
    <nav>
        ...
        <a href="<?= ROOT_URL ?>index.php" class="logo">Hospital website</a>
               ...
               <?php if(isset($_SESSION['user_id'])) :  ?>     
                   ...
                   <?php else: ?>
                    <li><a href="<?= ROOT_URL ?>hms/user_login.php">Signin</a></li>
                    <?php endif ?>
                </ul>
...
<?php
$my_query = "SELECT * FROM patients WHERE id = $id";
$my_result = mysqli_query($connect, $my_query);
if(mysqli_num_rows($my_result) > 0){
    $patients = mysqli_fetch_assoc($my_result);
    }
?>
<div class="profile_main">
   <p>Username :  <?=  $patients['username'];  ?></p>
   <p>email :  <?=  $patients['email'];  ?></p>
  <p>Profile pic  :  <?=  $patients['file'];  ?></p>
</div>
